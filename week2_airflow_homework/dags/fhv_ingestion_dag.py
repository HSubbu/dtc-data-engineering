...
OUTPUT_FILE_TEMPLATE = AIRFLOW_HOME + '/raw/' + RAW_FILENAME.replace('fhv_tripdata', 'fhv_output')
PARQUET_FILE_TEMPLATE = OUTPUT_FILE_TEMPLATE.replace('.csv', '.parquet')
BUCKET_FILENAME=RAW_FILENAME.replace('.csv','.parquet')
...
with DAG(
    ...
    local_to_gcs_task = PythonOperator(
        ...
        op_kwargs={
            "bucket": BUCKET,
            "object_name": f"fhv/{BUCKET_FILENAME}",
